...
def get_word():
    word = random.choice(word_rus).upper()
    return word
...
def play():
    ...
    while True:
        ...
        word_completion = []
        word_completion.extend('_' * len(word)) # строка, содержащая символы _ на каждую букву задуманного слова
        print(display_hangman(tries))
        guessed_letters = []  # список уже названных букв
        while guessed == False:
            if word_l == word_completion:
                print('Вы угадали!')
                guessed = True
                break
        ...
        question = input('Хотите сыграть еще раз? Введите "да" или любой символ: ')
        print(question)
        if question != 'да':
